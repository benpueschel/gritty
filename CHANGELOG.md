...
## [2.2.4](https://github.com/benpueschel/gritty/compare/2.2.3..2.2.4) - 2026-08-04

### 🐛 Bug Fixes

- *(install.sh)* Detect arch and fix some commands
...
- *(deps)* Bump bytes from 1.9.0 to 1.11.1 ([#21](https://github.com/benpueschel/gritty/pull/21))
- *(deps)* Bump rand from 0.8.5 to 0.8.6 ([#24](https://github.com/benpueschel/gritty/pull/24))
- *(deps)* Bump openssl from 0.10.72 to 0.10.78 ([#23](https://github.com/benpueschel/gritty/pull/23))
- *(deps)* Bump quinn-proto from 0.11.9 to 0.11.14 ([#22](https://github.com/benpueschel/gritty/pull/22))
- *(deps)* Bump rpassword from 7.3.1 to 7.5.0 ([#26](https://github.com/benpueschel/gritty/pull/26))
